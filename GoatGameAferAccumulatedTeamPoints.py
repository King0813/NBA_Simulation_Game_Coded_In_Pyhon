...
def remainingFundsFunction(accumulated_funds_holder, player_found_flag, remaining_funds, player_salary):
    ...
    if player_found_flag == 'Y':
        ...
        #print("funds in function", accumulated_funds_holder)
        #print("arffunc", accumulated_funds_holder)
...
def positionSelector(remaining_funds, position_selector_high, position_selector_low, team_scoring_total  , position_count, player_name, player_position, player_salary, player_ppg, player_apg, player_rings, player_defesive_rating):
    ...
    while player_found_flag is False:
        ...
        elif position_count < position_selector_low and position_count > position_selector_high:
            if error_count <= 2:
